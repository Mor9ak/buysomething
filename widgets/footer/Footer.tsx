...
const Footer = () => {
    return (
        <footer className="flex flex-col justify-center items-center gap-5 w-full bg-secBgCol border-t-2 border-borderCol mt-5 md:mt-9 uniPadding text-secTextCol absolute left-0 bottom-0">
